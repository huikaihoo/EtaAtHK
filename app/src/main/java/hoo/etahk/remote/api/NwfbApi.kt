...
interface NwfbApi {
    ...
    fun getParentRoutes(@Query("rno") rno: String = "",
                        ...
                        @Query("p") p: String = SharePrefs.NWFB_API_PARAMETER_PLATFORM,
                        @Query("appversion") appversion: String = SharePrefs.NWFB_API_PARAMETER_APP_VERSION): Call<ResponseBody>
    ...
    fun getEta(@Query("stopid") stopid: String = "",
               ...
               @Query("syscode") syscode: String = "",
               @Query("p") p: String = SharePrefs.NWFB_API_PARAMETER_PLATFORM,
               @Query("version") appversion: String = SharePrefs.NWFB_API_PARAMETER_APP_VERSION,
               @Query("version2") appversion2: String = SharePrefs.NWFB_API_PARAMETER_APP_VERSION_2,
