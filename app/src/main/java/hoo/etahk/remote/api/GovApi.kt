...
interface GovApi {
    ...
    fun getParentRoutes(@Query("route_name") route_name: String = "",
                        @Query("company_index") company_index: String = SharePrefs.GOV_API_PARAMETER_COMPANY_ALL_BUS,
                        @Query("lang") lang: String = "TC",
                        @Query("region") region: String = "",
                        @Query("syscode") syscode: String = "",
                        @Query("p") p: String = SharePrefs.GOV_API_PARAMETER_PLATFORM,
                        @Query("version") appversion: String = SharePrefs.GOV_API_PARAMETER_APP_VERSION): Call<ResponseBody>
}