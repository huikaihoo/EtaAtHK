...
import kotlinx.android.synthetic.main.item_spinner_single.view.title

class FollowSpinnerAdapter(context: Context): BaseArrayAdapter<LocationAndGroups>(context, R.layout.item_spinner_single) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (convertView == null) {
            ...
            view = inflater.inflate(R.layout.item_spinner_single, parent, false)
        } else {
            view = convertView
        }
