...
class RouteHistoryDiffCallback : DiffUtil.ItemCallback<RouteHistoryEx>() {
     ...
     */
    override fun areItemsTheSame(oldItem: RouteHistoryEx, newItem: RouteHistoryEx): Boolean {
        return (oldItem.history.company == newItem.history.company &&
                oldItem.history.routeNo == newItem.history.routeNo)
    }
     ...
     */
    override fun areContentsTheSame(oldItem: RouteHistoryEx, newItem: RouteHistoryEx): Boolean {
